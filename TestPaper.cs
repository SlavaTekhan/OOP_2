...
{/**
@class TestPaper
Класс, реализующий подсчет и сложение информации последовательно выводя его название, оценку и кол-во баллов.
*/

    public class TestPaper : MainTest
    {
        ...
        public TestPaper(int gettingScore, int mark, string subject)
            : base(subject)
        {   
